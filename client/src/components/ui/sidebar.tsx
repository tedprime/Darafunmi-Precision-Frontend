...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-4 shrink-0 mt-auto", className)}
      {...props}
    />
  );
}
...
// FIX: Added 'overflow-y-auto' explicitly to safely contain link flows
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto group-data-[collapsible=icon]:overflow-hidden px-2",
        className
      )}
      {...props}
    />
